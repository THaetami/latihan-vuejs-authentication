    ...
    <div class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        <form @submit.prevent="handleSubmit" class="mt-8 space-y-6">
            ...
            <div>
                ...
                <input v-model="fullname"  name="fullname" type="input" autocomplete="fullname" required class="p-2 relative block w-full rounded-t-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Fullname">
            </div>
            <div>
                <label for="username" class="sr-only">Username</label>
                <input v-model="username"  name="username" type="input" autocomplete="username" required class="p-2 relative block w-full rounded-t-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Username">
            </div>
            <div>
            ...
            <div class="flex items-center">
                ...
                <label for="remember-me" class="ml-2 block text-sm text-gray-900">Hide/Show</label>
            </div>
            </div>
