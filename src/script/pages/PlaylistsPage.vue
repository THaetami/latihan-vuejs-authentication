...
<div class="min-h-screen bg-slate-300">
    <modal-playlists :show="showModal1" @close="showModal1 = false" :getPlaylist="getPlaylists">
        <template #body>
    ...
    <div class="p-4 xl:ml-80">
        <div class="mt-12">
            <div v-if="$route.name === 'PlaylistsPage'" class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
