    ...
    <div class="p-4 xl:ml-80">
        <div class="mt-12">
            <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                <div v-for="playlist in playlists" v-bind:key="playlist.id" class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
...
<div id="authentication-modal" tabindex="-1" aria-hidden="true" class="bg-slate-400 fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form @submit.prevent="postPlaylist" class="space-y-6" >
                    <div>
                        ...
                        <input type="text" name="email" v-model="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required>
                    </div>

                    <button aria-hidden="true" type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add your playlists</button>
                </form>
            </div>
        </div>
    </div>
