    ...
    <div class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        <form class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div>
                ...
                <input id="name" name="name" type="input" autocomplete="name" required class="p-2 relative block w-full rounded-t-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Name">
            </div>
            <div>
                <label for="username" class="sr-only">Username</label>
                <input id="username" name="username" type="input" autocomplete="username" required class="p-2 relative block w-full rounded-t-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Username">
            </div>
            <div>
